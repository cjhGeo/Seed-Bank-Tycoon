...
const qnBank = [{"q": "What is primary the focus of the Singapore Botanic Gardens Seed Bank?", "o": ["Conservation, Research & Education", "Tourism & Hospitality", "Amatuer gardening", "Ideological reforms"], "a": "Conservation, Research & Education"}];
...
const onOptionSelect = event => {
    ...
    if (event.target.value == (qnBank[document.querySelector("#question").value]).a) {
        ...
        alert("womp womp *****, your fieldwork was unsuccessful!")
    }
